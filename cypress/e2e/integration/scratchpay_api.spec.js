describe('Scratchpay API Tests', () => {
  describe('When User is Authorized', () => {
    ...
    describe('Scenario 1: Prevent user (without permission) from getting the list of email addresses', () => {
    ...
    describe('Scenario 2: Search for clinics with the word "veterinary" in their name', () => {
    ...
    describe('Scenario 3: Search term is not given', () => {
  ...
  describe('When User is Unauthorized', () => {
    describe('Scenario 4: Prevent user (Unauthorized) from getting the list of email addresses', () => {
    ...
    describe('Scenario 5: Prevent user (Unauthorized) from getting the list clinics with the word "veterinary" in their name', () => {
